# Assignment : Few-shot OpenQA with ColBERT Retrieval
...
These adjustments were applied during execution so the notebook could complete and produce the final bakeoff JSON.
